...
<img src="https://img.shields.io/badge/TensorFlow-Keras-orange?logo=tensorflow&logoColor=white&style=for-the-badge" alt="TensorFlow">
<img src="https://img.shields.io/badge/Google-Colab-F9AB00?logo=googlecolab&logoColor=white&style=for-the-badge" alt="Colab">
...
```mermaid
flowchart LR
    A[📚 Teórico-expositiva] --> B[📊 Slides]
    A --> C[📐 Demonstrações matemáticas]
    B --> D[✍️ Derivação analítica manual]
    C --> D
    D --> E[🖥️ Hands-on no Colab]
    E --> F[✅ Scripts em Python]
```
...
|:----------:|:-----:|:-----------|
| **Google Colab** | <img src="https://upload.wikimedia.org/wikipedia/commons/d/d0/Google_Colaboratory_SVG_Logo.svg" width="24"> | Ambiente de notebooks na nuvem |
